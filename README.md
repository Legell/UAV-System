...
3. [Установка HeadScale на сервер VPS/VDS](#3)
4. [Установка и настройка TailScale (Repka Pi, либо любой другой linux компьютер](#4)
5. [Установка и настройка MAVProxy на Repka pi](#5)
...
---
## 🧰 Установка Headscale (сервер) <a name="3"></a> 
...
---
## 🧠 Установка и настройка клиента (Repka Pi, либо любой другой linux компьютер) <a name="4"></a> 
