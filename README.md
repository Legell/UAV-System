...
2. [Основные компоненты](#2)
3. [Установка HeadScale на сервер VPS/VDS](#Установка-Headscale-(сервер))
4. [Установка Headscale (сервер)](#установка-headscale-сервер)
5. [Установка Tailscale (клиенты)](#_🧠_Установка_и_настройка_клиента_(Repka_Pi,_либо_любой_другой_linux_компьютер))
6. [Вариант 1 — QGroundControl](#вариант-1--подключение-qgroundcontrol)
7. [Вариант 2 — Flask Web UI](#вариант-2--запуск-flask-web-ui)
8. [MAVProxy и ретрансляция телеметрии](#настройка-mavproxy)
9. [3D-модель корпуса Raspberry Pi](#3d-модель-корпуса-raspberry-pi)
10. [Авторы и благодарности](#авторы-и-благодарности)
